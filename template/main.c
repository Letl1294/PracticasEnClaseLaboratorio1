...
int main()
{
    ...
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,1,"video.avi","20911911915",9);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,2,"video1.avi","20911911915",4);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,3,"video2.avi","30911911915",300);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,4,"video3.avi","30911911915",400);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,5,"video4.avi","40911911915",500);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,6,"video5.avi","40911911915",600);
    ...
    do
    {
        ...
        switch(menu)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                //pantalla_menor(array,QTY);
               // pantalla_mayor(array,QTY);
                //pantalla_NoSuperanPromedio(array,QTY);
               //pantalla_SuperanPromedio(array,QTY);
               informar_ContraMen10Dias(array,contrataciones,QTY,LEN_CONT);
            break;
